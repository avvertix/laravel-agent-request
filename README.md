# This is my package laravel-agent-request
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-agent-request.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-agent-request)
...
```bash
php artisan vendor:publish --tag="laravel-agent-request-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-agent-request-views"
```

## Usage

```php
$laravelAgentRequest = new Avvertix\AgentRequest\LaravelAgentRequest();
echo $laravelAgentRequest->echoPhrase('Hello, Avvertix\AgentRequest!');
```
